...
declare module TypeScript.Syntax {
    class VariableWidthTokenWithNoTrivia implements TypeScript.ISyntaxToken {
        ...
        constructor(fullText: string, kind: TypeScript.SyntaxKind);
    ...
    class VariableWidthTokenWithLeadingTrivia implements TypeScript.ISyntaxToken {
        ...
        constructor(fullText: string, kind: TypeScript.SyntaxKind, leadingTriviaInfo: number);
        public clone(): TypeScript.ISyntaxToken;
        public isNode(): boolean;
        public isToken(): boolean;
        public isList(): boolean;
    ...
    class VariableWidthTokenWithTrailingTrivia implements TypeScript.ISyntaxToken {
        ...
        constructor(fullText: string, kind: TypeScript.SyntaxKind, trailingTriviaInfo: number);
        public clone(): TypeScript.ISyntaxToken;
        public isNode(): boolean;
        public isToken(): boolean;
        public isList(): boolean;
    ...
    class VariableWidthTokenWithLeadingAndTrailingTrivia implements TypeScript.ISyntaxToken {
        ...
        private _leadingTriviaInfo;
        private _trailingTriviaInfo;
        constructor(fullText: string, kind: TypeScript.SyntaxKind, leadingTriviaInfo: number, trailingTriviaInfo: number);
        public clone(): TypeScript.ISyntaxToken;
        public isNode(): boolean;
        public isToken(): boolean;
        public isList(): boolean;
...
declare module TypeScript.ASTHelpers {
    function scriptIsElided(sourceUnit: TypeScript.SourceUnit): boolean;
    function moduleIsElided(declaration: TypeScript.ModuleDeclaration): boolean;
    function enumIsElided(declaration: TypeScript.EnumDeclaration): boolean;
    function isValidAstNode(ast: TypeScript.IASTSpan): boolean;
    function getAstAtPosition(script: TypeScript.AST, pos: number, useTrailingTriviaAsLimChar?: boolean, forceInclusive?: boolean): TypeScript.AST;
    function getExtendsHeritageClause(clauses: TypeScript.ISyntaxList2): TypeScript.HeritageClause;
    function getImplementsHeritageClause(clauses: TypeScript.ISyntaxList2): TypeScript.HeritageClause;
    function isCallExpression(ast: TypeScript.AST): boolean;
    function isCallExpressionTarget(ast: TypeScript.AST): boolean;
    function isDeclarationASTOrDeclarationNameAST(ast: TypeScript.AST): boolean;
    function getEnclosingParameterForInitializer(ast: TypeScript.AST): TypeScript.Parameter;
    function getEnclosingMemberVariableDeclaration(ast: TypeScript.AST): TypeScript.MemberVariableDeclaration;
    function isNameOfFunction(ast: TypeScript.AST): boolean;
    function isNameOfMemberFunction(ast: TypeScript.AST): boolean;
    function isNameOfMemberAccessExpression(ast: TypeScript.AST): boolean;
    function isRightSideOfQualifiedName(ast: TypeScript.AST): boolean;
    function parametersFromIdentifier(id: TypeScript.Identifier): TypeScript.IParameters;
    function parametersFromParameter(parameter: TypeScript.Parameter): TypeScript.IParameters;
    function parametersFromParameterList(list: TypeScript.ParameterList): TypeScript.IParameters;
    function isDeclarationAST(ast: TypeScript.AST): boolean;
    function docComments(ast: TypeScript.AST): TypeScript.Comment[];
    function getParameterList(ast: TypeScript.AST): TypeScript.ParameterList;
    function getType(ast: TypeScript.AST): TypeScript.AST;
    function getVariableDeclaratorModifiers(variableDeclarator: TypeScript.VariableDeclarator): TypeScript.PullElementFlags[];
    function isIntegerLiteralAST(expression: TypeScript.AST): boolean;
    function getEnclosingModuleDeclaration(ast: TypeScript.AST): TypeScript.ModuleDeclaration;
    function isLastNameOfModule(ast: TypeScript.ModuleDeclaration, astName: TypeScript.AST): boolean;
    function isAnyNameOfModule(ast: TypeScript.ModuleDeclaration, astName: TypeScript.AST): boolean;
    function getNameOfIdenfierOrQualifiedName(name: TypeScript.AST): string;
}
declare module TypeScript {
...
declare module TypeScript {
    class PullDecl {
        ...
        constructor(declName: string, displayName: string, kind: TypeScript.PullElementKind, declFlags: TypeScript.PullElementFlags, semanticInfoChain: TypeScript.SemanticInfoChain);
        public fileName(): string;
...
declare module TypeScript {
    ...
    class PullSignatureSymbol extends PullSymbol implements InstantiableSymbol {
        ...
        constructor(kind: TypeScript.PullElementKind, _isDefinition?: boolean);
        ...
        public _wrapsSomeTypeParameterIntoInfinitelyExpandingTypeReference(enclosingType: PullTypeSymbol, knownWrapMap: TypeScript.IBitMatrix): boolean;
        public _wrapsSomeTypeParameterIntoInfinitelyExpandingTypeReferenceWorker(enclosingType: PullTypeSymbol, knownWrapMap: TypeScript.IBitMatrix): boolean;
    }
    class PullTypeSymbol extends PullSymbol implements InstantiableSymbol {
        ...
        public _wrapsSomeTypeParameterIntoInfinitelyExpandingTypeReferenceRecurse(enclosingType: PullTypeSymbol, knownWrapMap: TypeScript.IBitMatrix): boolean;
    ...
    function getIDForTypeSubstitutions(instantiatingType: PullTypeSymbol, typeArgumentMap: PullTypeSymbol[]): string;
    function getIDForTypeSubstitutions(instantiatingSignature: PullSignatureSymbol, typeArgumentMap: PullTypeSymbol[]): string;
...
declare module TypeScript {
    class PullTypeEnclosingTypeWalker {
        ...
        public getEnclosingType(): TypeScript.PullTypeSymbol;
        public _canWalkStructure(): boolean;
        public _getCurrentSymbol(): TypeScript.PullSymbol;
        public getGenerativeClassification(): TypeScript.GenerativeTypeClassification;
        ...
        public setCurrentSymbol(symbol: TypeScript.PullSymbol): void;
        public startWalkingType(symbol: TypeScript.PullTypeSymbol): TypeScript.PullSymbol[];
        public endWalkingType(currentSymbolsWhenStartedWalkingTypes: TypeScript.PullSymbol[]): void;
        public setEnclosingType(symbol: TypeScript.PullSymbol): void;
        public walkMemberType(memberName: string, resolver: TypeScript.PullTypeResolver): void;
        public postWalkMemberType(): void;
        public walkSignature(kind: TypeScript.PullElementKind, index: number): void;
        ...
        public getBothKindOfIndexSignatures(resolver: TypeScript.PullTypeResolver, context: TypeScript.PullTypeResolutionContext, includeAugmentedType: boolean): TypeScript.IndexSignatureInfo;
        public walkIndexSignatureReturnType(indexSigInfo: TypeScript.IndexSignatureInfo, useStringIndexSignature: boolean, onlySignature?: boolean): void;
...
declare module TypeScript {
    class CandidateInferenceInfo {
        ...
        public fixTypeParameter(resolver: TypeScript.PullTypeResolver, context: PullTypeResolutionContext): void;
    }
    class TypeArgumentInferenceContext {
        public resolver: TypeScript.PullTypeResolver;
        public context: PullTypeResolutionContext;
        public signatureBeingInferred: TypeScript.PullSignatureSymbol;
        public inferenceCache: TypeScript.IBitMatrix;
        public candidateCache: CandidateInferenceInfo[];
        constructor(resolver: TypeScript.PullTypeResolver, context: PullTypeResolutionContext, signatureBeingInferred: TypeScript.PullSignatureSymbol);
        ...
        public inferTypeArguments(): TypeScript.PullTypeSymbol[];
        public fixTypeParameter(typeParameter: TypeScript.PullTypeParameterSymbol): void;
        public getFixedTypeParameterSubstitutions(): TypeScript.PullTypeSymbol[];
        public _finalizeInferredTypeArguments(): TypeScript.PullTypeSymbol[];
    ...
    class InvocationTypeArgumentInferenceContext extends TypeArgumentInferenceContext {
        ...
        constructor(resolver: TypeScript.PullTypeResolver, context: PullTypeResolutionContext, signatureBeingInferred: TypeScript.PullSignatureSymbol, argumentASTs: TypeScript.ISeparatedSyntaxList2);
        public isInvocationInferenceContext(): boolean;
        public inferTypeArguments(): TypeScript.PullTypeSymbol[];
    }
    class ContextualSignatureInstantiationTypeArgumentInferenceContext extends TypeArgumentInferenceContext {
        ...
        constructor(resolver: TypeScript.PullTypeResolver, context: PullTypeResolutionContext, signatureBeingInferred: TypeScript.PullSignatureSymbol, contextualSignature: TypeScript.PullSignatureSymbol, shouldFixContextualSignatureParameterTypes: boolean);
        public isInvocationInferenceContext(): boolean;
        public inferTypeArguments(): TypeScript.PullTypeSymbol[];
    }
    class PullContextualTypeContext {
        ...
        constructor(contextualType: TypeScript.PullTypeSymbol, provisional: boolean, isInferentiallyTyping: boolean, typeArgumentInferenceContext: TypeArgumentInferenceContext);
    ...
    class PullTypeResolutionContext {
        ...
        public enclosingTypeWalker1: TypeScript.PullTypeEnclosingTypeWalker;
        public enclosingTypeWalker2: TypeScript.PullTypeEnclosingTypeWalker;
        ...
        public pushInferentialType(type: TypeScript.PullTypeSymbol, typeArgumentInferenceContext: TypeArgumentInferenceContext): void;
        ...
        public fixAllTypeParametersReferencedByType(type: TypeScript.PullTypeSymbol, resolver: TypeScript.PullTypeResolver, argContext?: TypeArgumentInferenceContext): TypeScript.PullTypeSymbol;
        ...
        public setSymbolForAST(ast: TypeScript.AST, symbol: TypeScript.PullSymbol): void;
        public getSymbolForAST(ast: TypeScript.AST): TypeScript.PullSymbol;
        public startWalkingTypes(symbol1: TypeScript.PullTypeSymbol, symbol2: TypeScript.PullTypeSymbol): {
            symbolsWhenStartedWalkingTypes1: TypeScript.PullSymbol[];
            symbolsWhenStartedWalkingTypes2: TypeScript.PullSymbol[];
        };
        public endWalkingTypes(symbolsWhenStartedWalkingTypes: {
            symbolsWhenStartedWalkingTypes1: TypeScript.PullSymbol[];
            symbolsWhenStartedWalkingTypes2: TypeScript.PullSymbol[];
        }): void;
        public setEnclosingTypes(symbol1: TypeScript.PullSymbol, symbol2: TypeScript.PullSymbol): void;
        public walkMemberTypes(memberName: string): void;
        public postWalkMemberTypes(): void;
        public walkSignatures(kind: TypeScript.PullElementKind, index: number, index2?: number): void;
        ...
        public getBothKindOfIndexSignatures(includeAugmentedType1: boolean, includeAugmentedType2: boolean): {
            indexSigs1: TypeScript.IndexSignatureInfo;
            indexSigs2: TypeScript.IndexSignatureInfo;
        };
        ...
        public resetEnclosingTypeWalkers(): {
            enclosingTypeWalker1: TypeScript.PullTypeEnclosingTypeWalker;
            enclosingTypeWalker2: TypeScript.PullTypeEnclosingTypeWalker;
        };
...
declare module TypeScript {
    ...
    interface IndexSignatureInfo {
        numericSignature: TypeScript.PullSignatureSymbol;
        stringSignature: TypeScript.PullSignatureSymbol;
    }
    class PullTypeResolver {
        ...
        public _getNamedPropertySymbolOfAugmentedType(symbolName: string, parent: TypeScript.PullTypeSymbol): TypeScript.PullSymbol;
        ...
        public _getBothKindsOfIndexSignatures(enclosingType: TypeScript.PullTypeSymbol, context: TypeScript.PullTypeResolutionContext, includeAugmentedType: boolean): IndexSignatureInfo;
        ...
        public typesAreIdentical(t1: TypeScript.PullTypeSymbol, t2: TypeScript.PullTypeSymbol, context: TypeScript.PullTypeResolutionContext): boolean;
        ...
        public signaturesAreIdenticalWithNewEnclosingTypes(s1: TypeScript.PullSignatureSymbol, s2: TypeScript.PullSignatureSymbol, context: TypeScript.PullTypeResolutionContext, includingReturnType?: boolean): boolean;
        private signaturesAreIdentical(s1, s2, context, includingReturnType?);
        public signaturesAreIdenticalWorker(s1: TypeScript.PullSignatureSymbol, s2: TypeScript.PullSignatureSymbol, context: TypeScript.PullTypeResolutionContext, includingReturnType?: boolean): boolean;
        private signatureTypeParametersParametersAndReturnTypesAreIdentical(s1, s2, context, includingReturnType?);
        public signatureReturnTypesAreIdentical(s1: TypeScript.PullSignatureSymbol, s2: TypeScript.PullSignatureSymbol, context: TypeScript.PullTypeResolutionContext): boolean;
        ...
        public relateTypeToTypeParametersWithNewEnclosingTypes(expressionType: TypeScript.PullTypeSymbol, parameterType: TypeScript.PullTypeSymbol, argContext: TypeScript.TypeArgumentInferenceContext, context: TypeScript.PullTypeResolutionContext): void;
        public relateTypeToTypeParameters(expressionType: TypeScript.PullTypeSymbol, parameterType: TypeScript.PullTypeSymbol, argContext: TypeScript.TypeArgumentInferenceContext, context: TypeScript.PullTypeResolutionContext): void;
        private relateTypeToTypeParametersWorker(expressionType, parameterType, argContext, context);
        ...
        private relateArrayTypeToTypeParameters(argArrayType, parameterArrayType, argContext, context);
        ...
        public instantiateType(type: TypeScript.PullTypeSymbol, typeParameterArgumentMap: TypeScript.PullTypeSymbol[]): TypeScript.PullTypeSymbol;
        public instantiateTypeParameter(typeParameter: TypeScript.PullTypeParameterSymbol, typeParameterArgumentMap: TypeScript.PullTypeSymbol[]): TypeScript.PullTypeParameterSymbol;
        public instantiateSignature(signature: TypeScript.PullSignatureSymbol, typeParameterArgumentMap: TypeScript.PullTypeSymbol[]): TypeScript.PullSignatureSymbol;
    }
...
declare module TypeScript {
    module PullHelpers {
        function diagnosticFromDecl(decl: TypeScript.PullDecl, diagnosticKey: string, _arguments?: any[], additionalLocations?: TypeScript.Location[]): TypeScript.Diagnostic;
        function resolveDeclaredSymbolToUseType(symbol: TypeScript.PullSymbol): void;
        ...
        interface PullTypeSymbolStructureWalker {
            memberSymbolWalk(memberSymbol: TypeScript.PullSymbol): boolean;
            callSignatureWalk(signatureSymbol: TypeScript.PullSignatureSymbol): boolean;
            constructSignatureWalk(signatureSymbol: TypeScript.PullSignatureSymbol): boolean;
            indexSignatureWalk(signatureSymbol: TypeScript.PullSignatureSymbol): boolean;
            signatureParameterWalk(parameterSymbol: TypeScript.PullSymbol): boolean;
            signatureReturnTypeWalk(returnType: TypeScript.PullTypeSymbol): boolean;
        }
        function walkPullTypeSymbolStructure(typeSymbol: TypeScript.PullTypeSymbol, walker: PullTypeSymbolStructureWalker): void;
        class OtherPullDeclsWalker {
            private currentlyWalkingOtherDecls;
            public walkOtherPullDecls(currentDecl: TypeScript.PullDecl, otherDecls: TypeScript.PullDecl[], callBack: (otherDecl: TypeScript.PullDecl) => void): void;
        }
    }
}
declare module TypeScript {
    class WrapsTypeParameterCache {
        private _wrapsTypeParameterCache;
        public getWrapsTypeParameter(typeParameterArgumentMap: TypeScript.PullTypeSymbol[]): number;
        public setWrapsTypeParameter(typeParameterArgumentMap: TypeScript.PullTypeSymbol[], wrappingTypeParameterID: number): void;
    }
    module PullInstantiationHelpers {
        class MutableTypeArgumentMap {
            public typeParameterArgumentMap: TypeScript.PullTypeSymbol[];
            public createdDuplicateTypeArgumentMap: boolean;
            constructor(typeParameterArgumentMap: TypeScript.PullTypeSymbol[]);
            public ensureTypeArgumentCopy(): void;
        }
        function instantiateTypeArgument(resolver: TypeScript.PullTypeResolver, symbol: TypeScript.InstantiableSymbol, mutableTypeParameterMap: MutableTypeArgumentMap): void;
        function cleanUpTypeArgumentMap(symbol: TypeScript.InstantiableSymbol, mutableTypeArgumentMap: MutableTypeArgumentMap): void;
        function getAllowedToReferenceTypeParametersFromDecl(decl: TypeScript.PullDecl): TypeScript.PullTypeParameterSymbol[];
    }
}
declare module TypeScript {
...
declare module TypeScript {
    ...
    class PullTypeReferenceSymbol extends TypeScript.PullTypeSymbol {
        ...
        public appendCallSignature(callSignature: TypeScript.PullSignatureSymbol): void;
        public insertCallSignatureAtIndex(callSignature: TypeScript.PullSignatureSymbol, index: number): void;
        public appendConstructSignature(callSignature: TypeScript.PullSignatureSymbol): void;
        public insertConstructSignatureAtIndex(callSignature: TypeScript.PullSignatureSymbol, index: number): void;
    ...
    class PullInstantiatedTypeReferenceSymbol extends PullTypeReferenceSymbol {
        ...
        public getReferencedTypeSymbol(): TypeScript.PullTypeSymbol;
        static create(resolver: TypeScript.PullTypeResolver, type: TypeScript.PullTypeSymbol, typeParameterArgumentMap: TypeScript.PullTypeSymbol[]): PullInstantiatedTypeReferenceSymbol;
        constructor(referencedTypeSymbol: TypeScript.PullTypeSymbol, _typeParameterArgumentMap: TypeScript.PullTypeSymbol[], isInstanceReferenceType: boolean);
        public isGeneric(): boolean;
    ...
    class PullInstantiatedSignatureSymbol extends TypeScript.PullSignatureSymbol {
        private _typeParameterArgumentMap;
        public getTypeParameterArgumentMap(): TypeScript.PullTypeSymbol[];
        constructor(rootSignature: TypeScript.PullSignatureSymbol, _typeParameterArgumentMap: TypeScript.PullTypeSymbol[]);
        public getIsSpecialized(): boolean;
        public _getResolver(): TypeScript.PullTypeResolver;
        public getTypeParameters(): TypeScript.PullTypeParameterSymbol[];
        public getAllowedToReferenceTypeParameters(): TypeScript.PullTypeParameterSymbol[];
    }
    class PullInstantiatedTypeParameterSymbol extends TypeScript.PullTypeParameterSymbol {
        constructor(rootTypeParameter: TypeScript.PullTypeSymbol, constraintType: TypeScript.PullTypeSymbol);
        public _getResolver(): TypeScript.PullTypeResolver;
    }
}
declare module TypeScript {
